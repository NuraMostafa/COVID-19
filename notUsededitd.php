...
<div class="container">
    ...
    <div class="form">
        <form action="" method="POST" enctype="multipart/form-data">
		  FirstName: <input type="text" name="firstname" class="x" onkeyup="filter(this)" id="firstname"><br>
            <br>
             LastName: <input type="text" name="lastname" class="x" onkeyup="filter(this)" id="lastname"><br>
            <br>
   ...
   Username: <input type="text" name="username" class="x" onkeyup="filter(this)" id="username"><br>
            ...
            <br>
 Mobile: <input type="text" name="mobile" class="x" onkeyup="filter(this)" id="mobile"><br>
